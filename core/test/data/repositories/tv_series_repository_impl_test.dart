...
void main() {
  ...
  final tTvSeriesModelList = <TvSeriesModel>[tvSeriesModel];
  ...
  group('Get TV Series Detail', () {
    ...
    test(
      ...
      when(mockRemoteDataSource.getTvSeriesDetail(tId))
          .thenAnswer((_) async => tvSeriesResponse);
      // act
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      ...
      // act
      final result = await repository.saveWatchlist(tvSeriesDetail);
      // assert
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      ...
      // act
      final result = await repository.removeWatchlist(tvSeriesDetail);
      // assert
  ...
  group('get watchlist movies', () {
    test('should return list of Movies', () async {
      ...
      // assert
      final resultList = result.getOrElse(() => []);
      expect(resultList, [watchlistTvSeries]);
    });
  });
}
