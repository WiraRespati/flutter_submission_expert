...
void main() {
  ...
  group('Get TvSeries Detail', () {
    ...
    test('should change Tv Series when data is gotten successfully', () async {
      ...
      expect(provider.tvSeries, tvSeriesDetail);
  ...
  group('Watchlist', () {
    ...
    test('should execute save watchlist when function called', () async {
      // arrange
      when(mockSaveWatchlist.execute(tvSeriesDetail))
          .thenAnswer((_) async => Right('Success'));
      when(mockGetWatchlistStatus.execute(tvSeriesDetail.id))
          .thenAnswer((_) async => true);
      // act
      await provider.addWatchlist(tvSeriesDetail);
      // assert
      verify(mockSaveWatchlist.execute(tvSeriesDetail));
    });

    test('should execute remove watchlist when function called', () async {
      // arrange
      when(mockRemoveWatchlist.execute(tvSeriesDetail))
          .thenAnswer((_) async => Right('Removed'));
      when(mockGetWatchlistStatus.execute(tvSeriesDetail.id))
          .thenAnswer((_) async => false);
      // act
      await provider.removeFromWatchlist(tvSeriesDetail);
      // assert
      verify(mockRemoveWatchlist.execute(tvSeriesDetail));
    });
    ...
    test('should update watchlist status when add watchlist success', () async {
      ...
      await provider.addWatchlist(tvSeriesDetail);
      // assert
      verify(mockGetWatchlistStatus.execute(tvSeriesDetail.id));
      expect(provider.isAddedToWatchlist, true);
